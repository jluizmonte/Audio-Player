...
$(document).ready(function() {
    ...
    AP.init({
        playList: [{
            'icon': iconImage,
            'title': 'Obsessões pelo prazer e pela sexualidade',
            'file': 'https://archive.org/download/kof96bigshotarranged/KOF%20%2796%20-%20Big%20Shot%21%20%28Arranged%29.mp3'
        }, {
            'icon': iconImage,
            'title': 'Suplica a Jesus',
            'file': 'https://archive.org/details/001_20190713/002.mp3'
        }, {
            'icon': iconImage,
            'title': 'Todo dia',
            'file': 'https://archive.org/details/podcast_EO/Grupo+Semente+-+Todo+Dia.mp3'
        }, {
            'icon': iconImage,
            'title': '180',
            'file': 'https://archive.org/download/esclarecimentosoportunos180dominiodosespiritossobreaspessoascompacto/Esclarecimentos%20Oportunos%20180%20-%20Dom%C3%ADnio%20dos%20esp%C3%ADritos%20sobre%20as%20pessoas%20-%20compacto.mp3'
        }, {
            'icon': iconImage,
            'title': 'Pop Tune',
